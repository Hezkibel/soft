...
<table width="100%" cellpadding="4" cellspacing="1" border="0">
	<tr>
		<td width="10%" align="center">'.(!empty($custom_48) ? '<img src="'.$custom_48.'" alt="">' : '<img src="'.$globals['mirror_images'].'webuzo/softimages/'.$soft.'__logo.gif" >').'</td>
		<td width="90%" class="sai_process_heading" colspan="4">'.$software['name'].'</td>
	</tr>
	<tr>
		<td align="center" width="10%">'.($soft > 10000 ? '' : '<div class="someclass" title="'.$apps[$soft]['ratings'].'"><table><tr>'.implode('', $ratings).'</tr></table></div>').'</td>
	...
	<td valign="top" style="padding:10px;">
		...
		<table width="100%" cellpadding="4" cellspacing="1" border="0">
			<tr>
				...
				<td valign="top" align="center" width="10%"><a href="'.$info['support'].'"><font color="#447edf"><i class="fa sai-question fa-3x"></i></font></a></td>
				<td valign="top" width="40%">
...
if(empty($globals['install_tweet_off']) || empty($globals['lictype'])){
	...
	<table border="0" cellpadding="5" cellspacing="1" align="center" class="sai_divroundshad">
		...
		<tr>
			<td valign="middle">
			<textarea name="text" cols="60" row="3" style="resize:none">'.loadtweetdata('install_tweet', $l['install_tweet_classes']).'</textarea>
			</td>
			<td valign="middle">
...
';
		...
		if(empty($iapps[$soft.'_1'])) {
			...
			<input type="submit" name="softsubmitbut" id="softsubmitbut" value="'.$l['softsubmit'].'" class="sai_graybluebut" /></center>';
		}else{
			...
			<input type="submit" name="softsubmitbut" id="softsubmitbut" onclick="return confirm_remove();" value="'.$l['remove'].'" class="sai_graybluebut" /></center>';
		}
