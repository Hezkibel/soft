...
if(empty($software)){
	...
	<title>Softaculous - '.$software['name'].' Demo</title>
	</head>
	<frameset rows="51,*" frameborder="0" border="0" framespacing="0">
	<frame src="https://www.softaculous.com/demoheader?sid='.$soft.'" scrolling="no" frameborder="0" noresize="noresize" name="demoheader">
	<frame src="https://demos.softaculous.com/'.($software['type'] == 'perl' ? 'cgi-bin/' : '').str_replace(' ', '_', $software['name']).'" style="margin:0px;padding:0px" frameborder="0" noresize="noresize" name="demobody">
