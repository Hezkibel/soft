...
echo '<form accept-charset="'.$globals['charset'].'" name="editadomain" method="post" action="" class="form-horizontal">
	<div class="sai_main_head" style="width:100%;" align="center">'.$l['edit_domain'].'</div><hr>';
	...
	<div class="row" id="ftp_pass">
		...
		<div class="col-sm-7">
			<input type="text" name="ftp_pass" id="ftp_pass" class="form-control" value="'.POSTval('ftp_pass', $thisdomain['ftp_pass']).'" /><br />
		</div>
	</div>
	...
	<div class="row" id="trauthpass">
		...
		<div class="col-sm-7">
			<input type="checkbox" name="auth_password" id="auth_password" '.POSTchecked('auth_password', (!empty($thisdomain['public_key']) ? false : true)).' /><br /><br />
		</div>
	</div>
	...
	<div class="row" id="pub">
		...
		<div class="col-sm-7">
			<input type="text" name="public_key" id="public_key" class="form-control" value="'.POSTval('public_key', $thisdomain['public_key']).'" /><br />
		</div>
	</div>
	...
	<div class="row" id="pri">
		...
		<div class="col-sm-7">
			<input type="text" name="private_key" id="private_key" class="form-control" value="'.POSTval('private_key', $thisdomain['private_key']).'" /><br />
		</div>
	</div>
