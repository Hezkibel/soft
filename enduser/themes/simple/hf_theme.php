...
'.((aefer() && allow_adddomain()) ? '<li><a href="'.$globals['ind'].'act=domains"><img src="'.$theme['images'].'domains.gif" alt="" tooltip="'.$l['go_domain'].'" /></a></li>' : '').
(webuzo() ? '<li><a href="'.$globals['ind'].'act=domainmanage"><img src="'.$theme['images'].'domains.gif" alt="" tooltip="'.$l['go_domain'].'" /></a></li>' : '').
(empty($globals['off_demo_link']) ? '<li><a href="'.$globals['ind'].'act=demos"><img src="'.$theme['images'].'demos.gif" alt="" tooltip="'.$l['go_demos'].'" /></a></li>' : '' ).
(empty($globals['off_rating_link']) ? '<li><a href="'.$globals['ind'].'act=ratings"><img src="'.$theme['images'].'ratings.gif" alt="" tooltip="'.$l['go_ratings'].'" /></a></li>' : '' ).'
<li><a href="'.$globals['ind'].'act=installations"><img src="'.$theme['images'].'installations.gif" alt="" tooltip="'.$l['go_installations'].'" /></a></li>'.
(webuzo() && (!$softpanel->is_sysapps_disable()) ? '<li><a href="'.$globals['ind'].'act=apps_installations"><img src="'.$theme['images'].'apps_installations.gif" alt="" tooltip="'.$l['go_apps_installations'].'" /></a></li>' : '').'
<li><a href="'.$globals['ind'].'act=eu_tasklist"><img src="'.$theme['images'].'tasklist.png" alt="" tooltip="'.$l['go_tasklist'].'" /></a></li>
<li><a href="'.$globals['ind'].'act=settings"><img src="'.$theme['images'].'settings.gif" alt="" tooltip="'.$l['go_settings'].'" /></a></li>'.
(empty($globals['disable_backup_restore']) ? '<li><a href="'.$globals['ind'].'act=backups"><img src="'.$theme['images'].'backups.gif" alt="" tooltip="'.$l['go_backups'].'" /></a></li>' : '').' 
'.(empty($globals['off_email_link']) ? '<li><a href="'.$globals['ind'].'act=email"><img src="'.$theme['images'].'emails.gif" alt="" tooltip="'.$l['go_email_settings'].'" /></a></li>' : '').
(empty($globals['off_sync_link']) ? '<li><a href="'.$globals['ind'].'act=sync"><img src="'.$theme['images'].'sync.gif" alt="" tooltip="'.$l['go_sync'].'" /></a></li>' : '').
(!empty($globals['eu_themes_premium']) && !empty($globals['lictype']) ? '<li><a href="'.$globals['ind'].'act=my_themes"><img src="'.$theme['images'].'pfx_icon.png" alt="" tooltip="'.$l['go_my_themes'].'" /></a></li>' : '').'
...
(!empty($globals['panel_hf']) && !empty($softpanel->can_shrink_nativeui) ? '<a href="javascript:set_pheader();" id="pheader_view" ><img src="'.$theme['this_images'].($_COOKIE['pheader'] == 'yes' ? 'expand.png" title="'.$l['expand_view'].'"' : 'collapse.png" title="'.$l['collapse_view'].'"').'></a>'  : '');
...
global $l;
	...
	if(!empty($error)){
		...
		$str .= '<table width="'.$table_width.'" cellpadding="2" cellspacing="1" class="sai_error" '.(($center) ? 'align="center"' : '' ).'>
			<tr>
			<td>
