...
$l['overwrite_exist'] = '<b>ИЛИ</b> <br />Поставете отметка в квадратчето, за да презапишете всички файлове и ще продължите';
...
$l['please_note'] = '<b>ВНИМАНИЕ</b>: Softaculous е просто автоматичен инсталатор на софтуер и не предоставя никаква подкрепа за отделните софтуерни пакети. Моля посетете уеб сайта за поддръжка на софтуера!';
$l['regards'] = 'Поздрави';
