...
$l['please_note'] = '<b>ВНИМАНИЕ</b>: Softaculous е просто автоматичен инсталатор и не предоставя никаква поддръжка за софтуера. Моля посетете уеб сайта за поддръжка на софтуера!';
$l['regards'] = 'Regards';
