...
$l['ftp_user'] = 'FTP gebruikersnaam';
$l['ftp_user_exp'] = 'De gebruikersnaam van uw FTP account';
$l['ftp_pass'] = 'FTP wachtwoord';
...
$l['auth_password'] = 'Authenticatie via een wachtwoord of een public key';
$l['auth_password_exp'] = 'Check de box wanneer de authenticatie via een wachtwoord moet worden gebruikt';
$l['public_key'] = 'Public key';
$l['public_key_exp'] = 'Path naar de public key';
$l['private_key'] = 'Private key';
$l['private_key_exp'] = 'Path naar de private key';
