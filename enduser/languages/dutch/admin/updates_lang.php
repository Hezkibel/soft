...
$l['unable_connect'] = 'De verbinding met <a href="http://www.'.APP.'.com">'.APP.'</a> is mislukt';
...
//Theme Strings
$l['<title>'] = APP.' - Update center';//'.APP.' - Update Center
...
$l['update_softaculous'] = 'Update '.APP.'';//Update Softaculous
$l['cur_ver'] = 'Huidige versie';//Current Version
$l['latest_ver'] = 'Laatste Versie';//Latest Version
$l['not_connect_soft'] = 'Kan geen verbinding maken met '.APP.'';//Could not connect to '.APP.'
$l['updatesoftaculous'] = 'Update '.APP.'';//Update Sofaculous
