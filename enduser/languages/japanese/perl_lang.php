...
$l['overwrite_exist'] = '<b>OR</b> <br /> ファイルを上書きして続行するため、チェックボックスを選択して下さい。';
...
$l['please_note'] = ' <b>注意</b>: Softaculous は自動ソフトウェアインストーラーであるため、ソフトウェアパッケージのサポートは提供しておりません。サポートを受けるには、ソフトウェア提供元もウェブサイトをご参照下さい。';
$l['regards'] = 'Regards';
