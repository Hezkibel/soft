...
$l['please_note'] = '※Softaculous は自動ソフトウェアインストーラーのため、個々のソフトウェア・パッケージについて、いかなるサポートの提供も行っておりません。サポートに関しては、ソフトウェア販売元のサイトをご参照下さい。';
$l['regards'] = '注意';
...
$l['overwrite_exist'] = '全てのファイル上書のため、チェックボックスを選択し、次へ進んで下さい。';
