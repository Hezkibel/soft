...
$l['please_note'] = ' <b>注意</b>: Softaculousは自動インストーラーのため、個別のソフトウェアパッケージについて、いかなるサポートも提供しておりません。サポートが必要な場合は、ソフトウェア提供元のウェブサイトをご参照下さい。';
$l['regards'] = '注意';
...
$l['overwrite_exist'] = ' <b>または</b> <br />全てのファイルを上書きして続けるには、チェックボックスを選択して下さい。';
$l['overwrite'] = '上書きファイル';
