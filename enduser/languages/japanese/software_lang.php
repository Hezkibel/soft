...
$l['overwrite_exist'] = ' <b>もしくは</b> <br />チェックボックスを選択して、ファイルを上書きし、続行して下さい。';
...
$l['please_note'] = '<b>注</b>: Softaculousは、自動ソフトウェアインストーラーであり、いかなるソフトウェアのサポートも提供しておりません。サポートを受けるためには、ソフトウェア提供元のウェブサイトをご参照下さい。';
$l['regards'] = 'Regards';
...
$l['exp_eu_auto_upgrade'] = 'チェックを入れた場合、新バージョンが利用可能になった際に、このインスタレーションは自動的に最新バージョンへアップグレードされます。';
$l['auto_upgrade_enabled'] = '自動アップグレードは無効です。';
$l['bad'] = 'Bad';
$l['good'] = 'Good';
$l['strong'] = 'Strong';
$l['short'] = 'Short';
