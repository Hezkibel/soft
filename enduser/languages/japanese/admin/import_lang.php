...
//Theme Strings
$l['<title>'] = APP.' ? スクリプトのインポート';
$l['importing_scripts'] = '他の自動インストーラーからスクリプトをインポートする。';
$l['no_import'] = 'インポートするスクリプトがありません。';
$l['importing_of'] = 'ユーザー名';
$l['start_import'] = 'インポートの開始';
$l['import_exp'] = 'このユーティリティは、他の自動インストーラーを使用してインストールされたスクリプトをインポートします。インポートを開始するには "'.$l['start_import'].'"をクリックして下さい。';
$l['no_users'] = 'サーバ上でユーザーを発見できませんでした。';
