...
$l['overwrite_exist'] = ' <b>もしくは</b> <br />チェックボックスを選択し、ファイルを上書きして続行して下さい。';
...
$l['please_note'] = '<b>注</b>: Softaculousは自動ソフトウェアインストーラーであり、ソフトウェアパッケージのいかなるサポートも提供しておりません。サポートを受けるためには、ソフトウェア販売元のウェブサイトをご参照下さい。 ';
$l['regards'] = 'Regards';
