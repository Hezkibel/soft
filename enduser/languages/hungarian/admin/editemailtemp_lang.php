...
<strong>$path</strong> : Útvonal<br />
<strong>$version</strong> : Version<br />
<strong>$url</strong> : URL<br />
<strong>$admin_url</strong> : Admin URL<br />
<strong>$datadirectory</strong> : Data Directory<br />
<strong>$admin_username</strong> : Adminisztrátor neve<br />
<strong>$admin_pass</strong> : Adminisztrátor jelszava<br />
<strong>$dbname</strong> : MySQL adatbázis<br />
<strong>$dbuser</strong> : MySQL felhasználó<br />
<strong>$dbhost</strong> : MySQL szerver<br />
<strong>$dbpass</strong> : MySQL jelszó<br />
<strong>$cron</strong> : Cron időzítő<br />
...
<strong>$time</strong> : Telepítés időpontja<br />
