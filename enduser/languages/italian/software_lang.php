...
$l['please_note'] = '<b>ATTENZIONE</b>: Softaculous &egrave; semplicemente un programma di Installareareazione Automatica e non fornisce alcun supporto per il software. Si prega di visitare il sito ufficiale del software per qualsiasi tipo di supporto!';
$l['regards'] = 'Saluti';
$l['softinstaller'] = 'Autoinstaller Softaculous';
$l['return'] = 'Ritorna alla Panoramica';
$l['current_ins'] = 'Installazioni correnti';
$l['link'] = 'Link';
$l['ins_time'] = 'Data di Installareareazione';
$l['version'] = 'Versione';
...
$l['exp_eu_auto_upgrade'] = 'Se spuntato, sarà fatto l\'upgrade automatico di questa installazione all\'ultima versione, quando è disponibile una nuova versione.';
