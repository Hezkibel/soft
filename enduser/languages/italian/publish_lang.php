...
$l['error_f0'] = 'Tqui was an error connecting to the remote site';
$l['error_f-1'] = 'Tqui was an error connecting to the remote site';
$l['error_f-2'] = 'Tqui was an error connecting to the remote site';
$l['error_f-3'] = 'Tqui was an error in changing directories (FTP)';
$l['error_fmkdir'] = 'Could not make the remote directory';
$l['error_fchdir'] = 'Tqui was an error in changing directories (FTP)';
$l['error_sql_export'] = 'Could not export the MySQL DB';
$l['error_up_myexec'] = 'Tqui was an error uploading the MySQL dumper';
$l['error_sql_create'] = 'Could not create the database on the remote website';
$l['error_sql_seldb'] = 'Could not select the database';
$l['error_sql_conn'] = 'Tqui was an error while connecting to the Remote database MySQL';
$l['error_sql_query'] = 'Tqui was an error while executing some MySQL queries';
...
$l['error_u_files'] = 'Tqui was an error while uploading the ZIP files';
$l['error_u_exec'] = 'Tqui was an error in uploading the UnZip library';
...
$l['choose_account'] = 'Remote Dimensioni';
$l['choose_account_exp'] = 'Choose the remote account wqui you want to publish this installation';
$l['dir'] = 'Nella directory';
...
$l['publishins'] = 'Publish Installazioni';
...
$l['publish_notes'] = 'Di seguito alcune note importanti. Si raccomanda la loro attenta lettura ';
...
$l['softinstaller'] = APP.' Installareareer';
