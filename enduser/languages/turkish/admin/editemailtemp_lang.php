...
<strong>$path</strong> : Dizin<br />
<strong>$version</strong> : Version<br />
<strong>$url</strong> : URL<br />
<strong>$admin_url</strong> : Admin URL<br />
<strong>$datadirectory</strong> : Veri Dizini<br />
<strong>$admin_username</strong> : Yönetici Adı<br />
<strong>$admin_pass</strong> : Yönetici Şifresi<br />
<strong>$dbname</strong> : MySQL Veri Tabanı<br />
<strong>$dbuser</strong> : MySQL DB Kullanıcısı<br />
<strong>$dbhost</strong> : MySQL DB Hostu<br />
<strong>$dbpass</strong> : MySQL DB Şifresi<br />
<strong>$cron</strong> : Cron İşi<br />
...
<strong>$time</strong> : Kurulum Zamanı<br />
