...
$l['please_note'] = '<b>NOTA</b>: Softaculous es únicamente un auto instalador y no provee ningún soporte para el software. Por favor, visita la web del desarrollador para encontrar soporte!';
