...
$l['protocol'] = 'Protokol';
$l['protocol_exp'] = 'Zvoľte protokol, ktorým bude Softculous komunikovať';
$l['auth_password'] = 'Autentizovať s pomocou hesla alebo verejného kľúča';
$l['auth_password_exp'] = 'Zaškrtnite štvorček pre autentifikovanie pomocou hesla';
$l['public_key'] = 'Verejný kľúč';
$l['public_key_exp'] = 'Cesta k verejnému kľúču';
$l['private_key'] = 'Súkromný kľúč';
$l['private_key_exp'] = 'Cesta k súkromnému kľúču';
